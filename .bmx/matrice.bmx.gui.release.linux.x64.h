#ifndef MATRICE_BMX_MATRICE_BMX_GUI_RELEASE_LINUX_X64_H
#define MATRICE_BMX_MATRICE_BMX_GUI_RELEASE_LINUX_X64_H

#include <brl.mod/blitz.mod/.bmx/blitz.bmx.release.linux.x64.h>
#include <ray.mod/lib.mod/.bmx/lib.bmx.release.linux.x64.h>
#include <brl.mod/basic.mod/.bmx/basic.bmx.release.linux.x64.h>
#include <brl.mod/maxlua.mod/.bmx/maxlua.bmx.release.linux.x64.h>
#include <ray.mod/math.mod/.bmx/math.bmx.release.linux.x64.h>
int _bb_main();
